...
public class Projectile : MonoBehaviour, IController
{
    ...
    public class ProjectileCreationParams
    {
        ...
        public ProjectileCreationParams(ProjectileSO projectileSO, Transform target, Vector3 originPos, object creator)
        {
            this.projectileSO = projectileSO;
            this.target = target;
    ...
    [HorizontalLine("子弹参数")]
    [SerializeField] protected object creator;
    [SerializeField] protected ProjectileSO projectileSO;
    [SerializeField] protected Transform target;
    [SerializeField] protected Vector2 direction;

    // 之后如果有必要的话可以提取出一个 IProjectileControl 接口
    [HorizontalLine("控制参数")]
    [SerializeField] protected bool doBehavior = true;
    [SerializeField] protected bool doTrigger = true;
